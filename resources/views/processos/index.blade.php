                ...
                <div class="card">
                    <div class="card-header" role="tab" id="id-{{$processo->id}}">
                        <div class="row">
                            <div class=" col-lg-10">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#{{$processo->id}}" aria-expanded="false"
                                       aria-controls="{{$processo->id}}">
                                        {{$processo->nome}}
                                    </a>
                                </h5>
                            </div>
                                            ...
                                            @if($processo->usuario_id === Auth::id())
                                                <div class="col col-lg-3">
                                                    <a class="btn btn-warning btn-sm" role="button"
                                                       href="{{route('processos.edit',['id'=>$processo->id])}}">Editar</a>

                                                    <a class="btn btn-danger btn-sm"
                                                       href="{{ route('processos.destroy',['id'=>$processo->id]) }}"
                                                       onclick="event.preventDefault();
                                                               document.getElementById('desativar-form{{$processo->id}}').submit();">Excluir</a>
                                                    <form id="desativar-form{{$processo->id}}"
                                                          action="{{ route('processos.destroy',['id'=>$processo->id]) }}"
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="id-{{$processoa->id}}">
                                <div class="row">
                                    <div class=" col-lg-11">
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" href="#{{$processoa->id}}" aria-expanded="false"
                                               aria-controls="{{$processoa->id}}">
                                                {{$processoa->nome}}
                                            </a>
                            ...
                            <div id="{{$processoa->id}}" class="collapse" role="tabpanel"
                                 aria-labelledby="id-{{$processoa->id}}"
                                 data-parent="#accordion">
                                <div class="card-body">
                                    <div class="row justify-content-md-center">
                                        <div class="col col-lg-10">
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="id-{{$processof->id}}">
                                <div class="row">
                                    <div class=" col-lg-11">
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" href="#{{$processof->id}}" aria-expanded="false"
                                               aria-controls="{{$processof->id}}">
                                                {{$processof->nome}}
                                            </a>
                            ...
                            <div id="{{$processof->id}}" class="collapse" role="tabpanel"
                                 aria-labelledby="id-{{$processof->id}}"
                                 data-parent="#accordion">
                                <div class="card-body">
                                    <div class="row justify-content-md-center">
                                        <div class="col col-lg-10">
